...
\begin{enumerate}[label=\textbf{UC-\arabic*}, ref=UC-\arabic*]
    ...
    \textbf{Attori:} Admin \\\\
    \textbf{Precondizioni:} L'admin si trova nella schermata principale e ha selezionato la tipologia di elemento "libro".\\
    \textbf{Flusso principale: } 
        \begin{enumerate}[label=\arabic*.]
    ...
    \textbf{Attori:} Admin\\\\
    \textbf{Precondizioni:} L'admin si trova nella schermata di visualizzazione e ha selezionata la tipologia di elemento "libro".\\
    \textbf{Flusso principale:} 
        \begin{enumerate}[label=\arabic*.]
    ...
    \textbf{Attori:} Admin \\\\
    \textbf{Precondizioni:} L'admin si trova nella schermata di visualizzazione e ha selezionato la tipologia di elemento "libro". \\
    \textbf{Flusso principale:} 
        \begin{enumerate}[label=\arabic*.]
    ...
    \textbf{Attori:} Admin\\\\
    \textbf{Precondizioni:} L'admin si trova nella schermata principale e ha selezionato la tipologia di elemento "studente".\\
    \textbf{Flusso principale:} 
        \begin{enumerate}[label=\arabic*.]
            \item L'admin avvia la funzione di inserimento.
            \item L'admin compila i campi specificati in \ref{df:studente}
            \item L'admin conferma l'operazione.
        \end{enumerate} 
    \textbf{Post-condizioni:} Lo studente è correttamente inserito nell'elenco studenti.\\\\
    \textbf{Flusso alternativo 1:}
        \begin{enumerate}
            \item[2] I dati inseriti sono errati. L'admin deve inserirne di nuovi. Si riparte dal punto 2. 
        \end{enumerate}
    \textbf{Flusso alternativo 2:}
        \begin{enumerate}
            \item[3] L'admin annulla l'operazione o chiude la finestra.
    ...
    \textbf{Flusso principale:} 
        \begin{enumerate}[label=\arabic*.]
            ...
            \item L'admin avvia la funzione di modifica.
            \item L'admin compila i campi (modificabili) specificati in \ref{df:studente}.
            \item L'admin conferma l'operazione
        \end{enumerate} 
    \textbf{Post-condizioni:} Lo studente è correttamente modificato.\\\\
    \textbf{Flusso alternativo 1:}
        \begin{enumerate}
            \item[2] I dati sono errati. L'admin deve inserirne di nuovi. Si riparte dal punto 2. 
        \end{enumerate}
    \textbf{Flusso alternativo 2:}
        \begin{enumerate}
            \item[2] L'admin annulla l'operazione o chiude la finestra.
        \end{enumerate}
    %
    \par\noindent\rule{\textwidth}{0.5pt}
    %
    ...
    \textbf{Attori:} Admin\\\\
    \textbf{Precondizioni:} L'admin si trova nella schermata principale e ha selezionato la tipologia di elemento "prestito"\\
    \textbf{Flusso principale:} 
        \begin{enumerate}[label=\arabic*.]
            \item L'admin avvia la funzione di inserimento.
            \item L'admin compila i campi specificati in \ref{df:prestito}.
            \item L'admin conferma l'operazione.
        \end{enumerate} 
    ...
    \textbf{Flusso principale:} 
        \begin{enumerate}[label=\arabic*.]
            ...
            \item L'admin avvia la funzione di modifica.
            \item L'admin compila i campi (modificabili) specificati in \ref{df:prestito}.
            \item L'admin conferma l'operazione.
        \end{enumerate} 
    ...
    \textbf{Attori:} Admin\\\\
    \textbf{Precondizioni:} L'admin si trova nella schermata principale e ha selezionato la tipologia di elemento "prestiti"\\
    \textbf{Flusso principale:} 
        \begin{enumerate}[label=\arabic*.]
            \item L'admin accede alla schermata di visualizzazione.
    ...
    \textbf{Flusso alternativo 2:}
        \begin{enumerate}
            \item[4] Il prestito è già stato estinto. L'operazione è annullata. 
        \end{enumerate}
    %
    \par\noindent\rule{\textwidth}{0.5pt}
    %
    ...
    \textbf{Attori:} Admin\\\\
    \textbf{Precondizioni:} L'admin si trova nella schermata principale. \\
    \textbf{Flusso principale:} 
        \begin{enumerate}[label=\arabic*.]
    ...
    \textbf{Flusso alternativo 1:}
        \begin{enumerate}
            \item[3] L'estensione del file selezionato è diversa da quella prevista. L'operazione è annullata: si ritorna al punto 1. 
        \end{enumerate}
    \textbf{Flusso alternativo 2:}
        \begin{enumerate}
            \item[3] Il formato del file selezionato è diverso da quello previsto. L'operazione è annullata si ritorna al punto 1.
        \end{enumerate}
    \textbf{Flusso alternativo 3:}
        \begin{enumerate}
            \item[3] L'admin annulla l'operazione o chiude la finestra.
